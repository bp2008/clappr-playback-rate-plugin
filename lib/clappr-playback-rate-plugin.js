...
var _playbackRateSelector = _interopRequireDefault(__webpack_require__(98));
...
var DEFAULT_PLAYBACK_RATE_SUFFIX = 'x'; // Used by getTitle method

var PlaybackRatePlugin = /*#__PURE__*/function (_UICorePlugin) {
  _inherits(PlaybackRatePlugin, _UICorePlugin);

  var _super = _createSuper(PlaybackRatePlugin);
  ...
  _createClass(PlaybackRatePlugin, [{
    ...
    key: "template",
    get: function get() {
      return (0, _player.template)(_playbackRateSelector["default"]);
    }
    /**
    ...
    value: function bindEvents() {
      if (_player.Events.CORE_ACTIVE_CONTAINER_CHANGED) this.listenTo(this.core, _player.Events.CORE_ACTIVE_CONTAINER_CHANGED, this.reload);else this.listenTo(this.core.mediaControl, _player.Events.MEDIACONTROL_CONTAINERCHANGED, this.reload);
      this.listenTo(this.core.mediaControl, _player.Events.MEDIACONTROL_RENDERED, this.render);
      this.listenTo(this.core.mediaControl, _player.Events.MEDIACONTROL_HIDE, this.hideContextMenu);
    }
  }, {
    ...
    value: function shouldRender() {
      return this.container && (this.playback.tagName === 'video' || this.playback.tagName === 'audio');
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var t = (0, _player.template)(_playbackRateSelector["default"]);
      var html = t({
      ...
      var style = _player.Styler.getStyleFor(_style["default"], {
    ...
    value: function onRateSelect(event) {
      ...
      var rate = event.target.dataset.playbackRateSelect; // data-playback-rate-select
    ...
    key: "positionMenu",
    value: function positionMenu($menu) {
      if (!$menu.is(":visible")) return;
      var parent = this.$el.get(0);
      var buttonW = this.$el.width();
      var buttonX = 0;
      var buttonY = 0;
      ...
      var maxHeight = buttonY;
      $menu.css('max-height', maxHeight + 'px');
      var w = $menu.width();
      var h = $menu.height();
      var x = buttonX + (buttonW - w) / 2;
      var y = buttonY - h;
      if (x + w > this.core.el.offsetWidth) x = this.core.el.offsetWidth - w;
      if (x < 0) x = 0;
    ...
    value: function toNumber(value) {
      value = Number(value); // Fallback to default playback rate if cannot be converted
    ...
    key: "getSelectedRate",
    value: function getSelectedRate() {
    ...
    value: function setActiveListItem(rateValue) {
      ...
      this.$("a[data-playback-rate-select=\"".concat(rateValue, "\"]")).addClass('active');
    }
  }, {
    key: "buttonElement",
    ...
    value: function getTitle() {
      ...
      for (var i in this.playbackRates) {
        if (this.playbackRates[i].value == rate) return this.playbackRates[i].label;
...
}(_player.UICorePlugin);

exports["default"] = PlaybackRatePlugin;
...
var getBuiltIn = __webpack_require__(14);
var getOwnPropertyNamesModule = __webpack_require__(23);
...
var toPrimitive = __webpack_require__(18);
var createPropertyDescriptor = __webpack_require__(16);
var nativeObjectCreate = __webpack_require__(11);
var objectKeys = __webpack_require__(49);
var getOwnPropertyNamesModule = __webpack_require__(23);
...
var toIndexedObject = __webpack_require__(10);
var nativeGetOwnPropertyNames = __webpack_require__(23).f;
...
var fails = __webpack_require__(3);
var create = __webpack_require__(11);
var getOwnPropertyNames = __webpack_require__(23).f;
var getOwnPropertyDescriptor = __webpack_require__(15).f;
var defineProperty = __webpack_require__(5).f;
